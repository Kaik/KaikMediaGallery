...
namespace Kaikmedia\GalleryModule\Form\Type\Hook\Providers;
 ...
 * @author Kaik
 */
class HooksProvidersType extends AbstractType
{
    ...
    {
        return 'kaikmedia_gallery_module_hooks_providers';
    }
