 ...
 * @author Kaik
 */
class AdditionalImagesProBundle extends AbstractProBundle implements HookProviderInterface
{
    use ServiceIdTrait;
     ...
     * @var area
     */
    private $area = 'provider.gallery.ui_hooks.additional_images';
    ...
    {
        return $this->translator->__('Additional images Provider');
    }
